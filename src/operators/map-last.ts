 ...
 * value is projected and previous values are emitted without projection.
 * This operator uses [pairwise()](https://rxjs.dev/api/operators/pairwise) internally and emits each value only when a next value is
 * emitted or the source observable completes.
 */
